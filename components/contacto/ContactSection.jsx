...
import { MapPin, Phone, Mail, Clock, Send, User, MessageSquare, Smartphone, Loader2 } from "lucide-react";
...
const initialState = { nombre: "", email: "", celular: "", consulta: "" };
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="relative">
                <label className="text-[10px] uppercase tracking-widest text-neutral-400 mb-2 block font-semibold">
                  Nombres Completos
                </label>
              ...
              <motion.button
                ...
                type="submit"
                disabled={loading}
                className="w-full group relative flex items-center justify-center gap-3 bg-neutral-900 text-white py-4 rounded-lg overflow-hidden transition-all hover:bg-[#A67C3D] disabled:opacity-70"
              >
                {loading ? (
                  <Loader2 size={16} className="animate-spin" />
                ) : (
                  <>
                    <span className="text-xs uppercase tracking-[0.3em] font-medium">Enviar Mensaje</span>
